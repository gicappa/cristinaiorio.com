...
function get_subpage_header() {
        do_action( 'get_subpage_header' );
        if ( file_exists( TEMPLATEPATH . '/subpage-header.php') )
                load_template( TEMPLATEPATH . '/subpage-header.php');
        else
                load_template( ABSPATH . 'wp-content/themes/default/subpage-header.php');
}
